...
let colors = ["red", "blue", "green", "white", "silver"];
...
// 17. Copying from that loop you just wrote, modify it to print every color's value and every color's index in this format: 3, purple or 0, blue
for (let i = 0; i < colors.length; i++) {
